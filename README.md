...
Currently, the steps involved 1) creating an SQLite3 database with point data from *.LAS files using the createDB.py command and 2) running either or both the ground classifier andcanopy surface classifier with the classify.py command.
